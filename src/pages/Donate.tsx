          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div className="bg-white rounded-3xl p-10 shadow-[0_20px_45px_rgba(0,0,0,0.08)] hover:-translate-y-2 transition">
              ...
              <ul className="space-y-4 text-[#374151]">
                <li>
                  <span className="font-medium">Account Name:</span> NGO Trust
                  Name
                </li>
                <li>
            ...
            <div className="bg-white rounded-3xl p-10 shadow-[0_20px_45px_rgba(0,0,0,0.08)] hover:-translate-y-2 transition">
              ...
              <ul className="space-y-4 text-[#374151]">
                ...
                <li>
                  <span className="font-medium">Bank Name:</span> Canara Bank
                </li>
                <li>
                  <span className="font-medium">Branch:</span> City Branch
                </li>
                <li>
                  <span className="font-medium">IFSC Code:</span> CNRB0005678
                </li>
              </ul>
            </div>
          </div>
